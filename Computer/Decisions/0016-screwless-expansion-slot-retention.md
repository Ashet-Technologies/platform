...
The PCI Express x4 connector already holds an Expansion Card tightly enough that removing a card by pulling it directly from the connector is not easy. The Expansion Slot guide rails make the installed fit tighter still.
...
- Card retention relies on the PCI Express x4 connector together with the Expansion Slot guide rails.
