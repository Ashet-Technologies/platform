# 0015 — Expansion Guard Guide Rails

**Status:** Accepted

## Decision

Each Expansion Guard must include **guard rails** that guide an Expansion Card into its PCI Express x4 connector during insertion.
...
- Expansion Guards include mechanical guide rails for Expansion Cards.
